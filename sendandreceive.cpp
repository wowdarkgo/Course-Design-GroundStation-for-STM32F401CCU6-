...
{
    ui->setupUi(this);
    this->setWindowTitle("串口收发");                        //设置主界面名称
    ...
    palette.setColor(QPalette::Background, QColor(240,240,240));//QColor(78,168,243)
...
void sendandreceive::on_bt_sendserialdata_clicked()
{
    ...
    {
       QMessageBox::critical(this,"温馨提示","串口未打开，请留意串口配置",QMessageBox::Yes,QMessageBox::Yes);
       return;
    }
...
void sendandreceive::timer_autosend_event()
{
    ...
    if(ui->opencolse->text()=="打开串口")
    {
       //QMessageBox::critical(this,"提示","窗口串口未打开，请点击打开按钮打开串口。",QMessageBox::Yes,QMessageBox::Yes);
       return;
    }
...
void sendandreceive::on_bt_send1_clicked()
{
    if(ui->opencolse->text()=="打开串口")
    {
       QMessageBox::critical(this,"提示","主窗口串口未打开。",QMessageBox::Yes,QMessageBox::Yes);
       return;
    }
...
void sendandreceive::init(void)
{
    ...
    {
        QMessageBox::warning(this,"警告！","未发现可用串口！请留意电脑与串口间的连接");
    }
...
void sendandreceive::on_opencolse_clicked()
{
    if(ui->opencolse->text()=="打开串口")
    {
        ...
        if(!bOK)
        {
            QMessageBox::critical(this,"错误","无法打开串口。",QMessageBox::Yes,QMessageBox::Yes);
            return;
        }
